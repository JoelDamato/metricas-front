...
const RankingPage = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-6">
      {/* Filtros */}
      <div className="flex justify-center items-center bg-white rounded-lg shadow-lg p-5 mb-5 gap-2">
        {/* Categoría */}
          ...
          <ul className="mt-2 text-gray-600">
            {selectedCloser.Details.map((detail, index) => (
              <li key={index} className="mb-1">
                Día: {detail.Dia}, Venta CLUB: {detail["Venta CLUB"]}, Ofertas Ganadas MEG: {detail["Ofertas Ganadas MEG"]}, Facturación: {detail.Facturacion}, Cash Collected: {detail["Cash Collected"]}
              </li>
            ))}
          </ul>
        </div>
